...
window.addEventListener('load', function() {
	...
	/*function showAccordionBlock(block) {
		//var parentBlock = block.closest('.order__subsector');
		//var currentAccordion = parentBlock.querySelector('.order__subsector-accord');

		if (!block.classList.contains('order__subsector-accord--active')) {
			hideAllAccords();
			block.classList.add('order__subsector-accord--active');			
		}
	}

	function hideAccordionBlock(block) {
		//var parentBlock = block.block.closest('.order__subsector');
		//var accordion = parentBlock.querySelector('.order__subsector-accord');

		if (block.classList.contains('order__subsector-accord--active')) {
			hideAllAccords();
			block.classList.remove('order__subsector-accord--active');			
		}
